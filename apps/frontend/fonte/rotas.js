...
export const ROTAS_POR_TELA = {
  ...
  'screen-settings-lgpd': 'configuracoes/lgpd',
  'screen-settings-motivos-eliminacao': 'configuracoes/motivos-eliminacao',
  'screen-settings-modelos-email': 'configuracoes/modelos-email',
  'screen-settings-etapas': 'configuracoes/etapas-processo',
